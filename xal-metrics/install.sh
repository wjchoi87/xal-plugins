...
cfg.setdefault("pluginConfig", {}).setdefault(package, {})
...
echo "(optional: set pluginConfig.metrics.enabled/persistence/stallThresholdMs)"
echo "restart Xal; metrics are collected automatically, view with /metrics"