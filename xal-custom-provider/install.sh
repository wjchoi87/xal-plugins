...
echo "restart Xal, then create as many provider profiles as you need:"
echo "  xal connect custom work   # protocol, base URL, and key are asked per profile"
echo "  xal connect custom home"
